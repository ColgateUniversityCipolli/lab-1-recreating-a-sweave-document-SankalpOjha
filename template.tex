...
The result is 41.15049. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
If we want to print this nicely, we can do so using the xtable package \citep{xtable}, which we can reference using the label (Table).
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\noindent Below is a table from a paper I’m currently working on. Without the analysis object in \tt{R}, I have to create this table myself.
